...
use \ArrayAccess;
/**
 * CorpusExistsResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 * @link
 */
class CorpusExistsResponse implements ArrayAccess
{
    /**
    ...
    /**
      * $exists True if the corpus exists
      * @var bool
      */
    protected $exists;
    ...
    /**
     * Sets exists
     * @param bool $exists True if the corpus exists
     * @return $this
     */

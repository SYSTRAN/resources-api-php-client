...
use \ArrayAccess;
/**
 * CorpusDeleteResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 * @link
 */
class CorpusDeleteResponse implements ArrayAccess
{
    /**
    ...
    static $SystranTypes = array(
        ...
        'files' => '\Systran\Client\Model\LiteCorpus[]'
    );
    ...
    /**
     * Sets files
     * @param \Systran\Client\Model\LiteCorpus[] $files List of deleted corpora
     * @return $this
     */

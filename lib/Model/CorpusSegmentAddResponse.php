...
use \ArrayAccess;
/**
 * CorpusSegmentAddResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 * @link
 */
class CorpusSegmentAddResponse implements ArrayAccess
{
    /**
    ...
    /**
      * $segments List of added segments ids
      * @var string[]
      */
    protected $segments;
    ...
    /**
     * Sets segments
     * @param string[] $segments List of added segments ids
     * @return $this
     */

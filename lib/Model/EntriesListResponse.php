...
use \ArrayAccess;
/**
 * EntriesListResponse Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Systran\Client
 ...
 * @link
 */
class EntriesListResponse implements ArrayAccess
{
    /**
    ...
    static $SystranTypes = array(
        ...
        'total_no_limit' => 'int',
        'entries' => '\Systran\Client\Model\EntryOutput[]'
    );
    ...
    /**
      * $total_no_limit Number of entries without skip/limit filter
      * @var int
      */
    ...
    /**
      ...
      * @var \Systran\Client\Model\EntryOutput[]
      */
    protected $entries;
    ...
    /**
     * Sets total_no_limit
     * @param int $total_no_limit Number of entries without skip/limit filter
     * @return $this
     */
    ...
    /**
     * Gets entries
     * @return \Systran\Client\Model\EntryOutput[]
     */
    ...
    /**
     * Sets entries
     * @param \Systran\Client\Model\EntryOutput[] $entries List of entries
     * @return $this
     */
